...
/**
 * Расчёт опор (крайние и промежуточные)
 * Формула:
 * - Крайние: 2 × уровни
...
/**
 * Расчёт балок
 * Формула: количество × ряды × балок/ряд × уровни
 */
 ...
 * Формула: (количество пролётов + 1) × 2
 */
...
/**
 * Расчёт распорок/раскосов (для 2+ этажей)
 * Формула:
 * - Если пролётов = 1: 2 раскоса (минимум)
